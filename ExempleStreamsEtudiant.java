...
//1. Étudiants ayant réussi (moyenne >= 
//10) :
//Etudiant[ID=1, Nom=Amina Fathi, Email=amina.Fathi@etu.ma, Moyenne=15,50]    
//Etudiant[ID=2, Nom=Youssef Hilmi, Email=youssef.Hilmi@etu.ma, Moyenne=12,00]Etudiant[ID=3, Nom=Fatima Zahrae Kettani, Email=fatima.kettani@etu.ma, Moyenne=17,80]
...
//Etudiant[ID=7, Nom=Zineb Ahamadi, Email=zineb.ahmadi@etu.ma, Moyenne=16,30]
//Etudiant[ID=5, Nom=Salma Najih, Email=salma.Najih@etu.ma, Moyenne=14,20]      
//Etudiant[ID=2, Nom=Youssef Hilmi, Email=youssef.Hilmi@etu.ma, Moyenne=12,00]Etudiant[ID=6, Nom=Hamza Farah, Email=hamza.Farah@etu.ma, Moyenne=11,70]        
//Etudiant[ID=4, Nom=Mehdi Jabrane, Email=mehdi.jabrane@etu.ma, Moyenne=9,50]   

//PS C:\Users\Hp\Desktop\javatp> ^C
//PS C:\Users\Hp\Desktop\javatp> 
//PS C:\Users\Hp\Desktop\javatp>  c:; cd 'c:\Users\Hp\Desktop\javatp'; & 'C:\Program Files\Java\jdk-25\bin\java.exe' '--enable-preview' '-XX:+ShowCodeDetailsInExceptionMessages' '-cp' 'C:\Users\Hp\AppData\Roaming\Code\User\workspaceStorage\a6480793c77f9736f326377a2d45f289\redhat.java\jdt_ws\jdt.ls-java-project\bin' 'ExempleStreamsEtudiant' 
========== EXEMPLES DE STREAMS JAVA ==========
...
//8. Étudiants groupés par mention :
  ...
  //  - Etudiant[ID=6, Nom=Hamza Farah, Email=hamza.Farah@etu.ma, Moyenne=11,70]  Échec : 1 étudiant(s)
   // - Etudiant[ID=4, Nom=Mehdi Jabrane, Email=mehdi.jabrane@etu.ma, Moyenne=9,50]
 ...
 // Assez Bien : 1 étudiant(s)
  //  - Etudiant[ID=2, Nom=Youssef Hilmi, Email=youssef.Hilmi@etu.ma, Moyenne=12,00]
 // Bien : 2 étudiant(s)
  //  - Etudiant[ID=1, Nom=Amina Fathi, Email=amina.Fathi@etu.ma, Moyenne=15,50]    - Etudiant[ID=5, Nom=Salma Najih, Email=salma.Najih@etu.ma, Moyenne=14,20]
